...
tf.app.flags.DEFINE_integer('max_iters', 80000, "Max iteration")
...
tf.app.flags.DEFINE_string('test_img', "data/demo", 'image distance network weights')
tf.app.flags.DEFINE_string('dis_weight', './data/imagenet_weights/dis_weights.txt', 'image distance network weights')
